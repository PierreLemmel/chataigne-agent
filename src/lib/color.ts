...
export const colorDescriptionSchema = z.object({
    ...
    hex: z.string().regex(colorsRegexes.hex),
    named: z.enum(namedColors).nullable(),
...
export function rgbaToDescription(color: RGB): ColorDescription {
    ...
    const named = rgbToNamedColor(rgb);
